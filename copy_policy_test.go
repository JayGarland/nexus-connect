...
func TestExtractCopyButtons_Specimens(t *testing.T) {
	...
	if buttons[0][0].Text != "Copy SHA" || buttons[0][0].CopyText != "3ec6050a1c74b030ce59686add81f42302a2613c" {
	...
	if buttons[0][0].Text != "Copy WIN" || buttons[0][0].CopyText != "001-006-20260816-003" {
	...
	if buttons[0][0].Text != "Copy path" || buttons[0][0].CopyText != "Rooms/workshop/workbench/review/WI-0022-cc-connect-telegram-consecutive-aggregation-seam.md" {
	...
	if buttons[0][0].Text != "Copy command" || buttons[0][0].CopyText != "git status --short" {
